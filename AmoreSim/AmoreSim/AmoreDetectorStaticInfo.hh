...
namespace AmoreDetectorStaticInfo {
    ...
    namespace AMoRE_200 {
        ...
        constexpr G4double cavern_nMode_radius = 12. * m;
				...
				// Muon Veto (PS)
				constexpr G4double longPSlength  = 1662 * mm; // real design 1670 mm ?? 
				constexpr G4double shortPSlength = 120 * cm;
				...
				constexpr G4double PMTroom_thickness = 200. * mm;
        ...
        constexpr G4double reflector_thick   = 64 * um; // 64 micro-meter
				...
				constexpr G4double bottomhole_w      = 3.  * mm;
        ...
        constexpr G4double wafer_thick    = 0.003 * cm; // 300 um
        constexpr G4double wafer_vac_thick = 0.001 * cm; // 100 um
        ...
        constexpr G4double OVCthick       = 0.5 * cm; //0.6 * cm;
				constexpr G4double ovc_gap        = 30 * mm;
				constexpr G4double ss_radius        = 1270. * mm / 2.;
        constexpr G4double ss_inner_height_half = 2890.* mm / 2;

        // Cu 1,2,3,4
        constexpr G4double cu4thick   = 3. * mm; //0.6 * cm;
				constexpr G4double cu4_radius = 1206. * mm /2.;
				constexpr G4double cu4_height = 2681 * mm /2.; //2464 * mm / 2.;

        constexpr G4double cu3thick   = 6. * mm; //1.0 * cm;
				constexpr G4double cu3_radius = 1142. * mm / 2.;
				constexpr G4double cu3_height = 2425. * mm / 2.;

        constexpr G4double cu2thick  = 1.5 * mm; //0.3 * cm;
				constexpr G4double cu2_radius = 1083.* mm / 2.; //1080. * mm / 2.;
				constexpr G4double cu2_height = 2141. * mm / 2.;

        constexpr G4double cu1thick  = 1.5 * mm;
				constexpr G4double cu1_radius = 1023. * mm / 2.; //1020. * mm / 2.;
				constexpr G4double cu1_height = 1887. * mm / 2.;
